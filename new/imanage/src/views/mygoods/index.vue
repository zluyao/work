    ...
    <div class="content-box">
      ...
      <div class="itemp"
        ...
        <div class="itemp-right">
          ...
          <div class="btns-box">
            <span class="sc"
                  :class="{'sc2':item.isShelf==0}"
                  @click="collectPro(item)">{{item.isShelf==0?'删除':'已收藏'}}</span>
            <span class="detail"
                  @click="toDetail(item.h5Url)">查看详情</span>
            <textarea :id="'input'+index" class="input">{{item.h5Url}}?supplierUserId={{supplierUserId}}</textarea>
